...
- 컴포넌트에 대한 이해, Routing, history, SSR, 상태 관리, 그리고 rerender를 위한 detection
- Flux
- Critical Path
- 서버 사이드 렌더링과 클라이언트 사이드 렌더링의 차이를 구분 장단점은
...
- 스티브 사우더스의 규칙 전부 ([고성능 웹사이트](http://shop.oreilly.com/product/9780596529307.do))
